        ...
        <section id={styles.about_me}>
            <motion.div className={styles.container}>
                ...
                <motion.div className={styles.interiorContainer}>
                    <motion.div initial= {{opacity: 0}} style={{opacity: appear_3}} className={styles.photoContainer}>
