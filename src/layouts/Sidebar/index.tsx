  ...
  return (
    <>
      <motion.div
        ...
        style={isVisible ? { background: "transparent", y: "-50%" } : { background: "radial-gradient(ellipse at left center, rgba(0, 0, 0, 0.26) 0%, transparent 70%)", y: "-50%" }}
      ></motion.div>
        ...
        <ul className={styles.menu}>
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <motion.p className={`${jls.className} ${styles.letter}`}>{item.label}</motion.p>
